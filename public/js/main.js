(function() {
  ...
  try {
    if (typeof document != "undefined") {
      ...
      elementStyle.appendChild(document.createTextNode('c-task {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  max-width: 584px;\n  width: 100%;\n  padding-left: 4px;\n  padding-right: 4px;\n  border-top: 0.5px rgba(0, 31, 61, 0.0509803922) solid;\n  border-bottom: 0.5px rgba(0, 31, 61, 0.0509803922) solid;\n  border-left: none;\n  border-right: none;\n  font-family: "San Francisco", sans-serif;\n}\nc-task.focus {\n  box-shadow: 0 0 0 2px #0099FF;\n}\nc-task input[type=text] {\n  width: 100%;\n  height: 36px;\n  font-size: 13px;\n  line-height: 20px;\n  letter-spacing: -0.6%;\n  color: rgba(2, 9, 13, 0.9411764706);\n  border: none;\n  font-family: inherit;\n}\nc-task input[type=text]::placeholder {\n  color: rgba(9, 32, 52, 0.4509803922);\n  font-style: italic;\n}\nc-task input[type=text]:focus-visible {\n  outline: none;\n}\nc-task input[type=checkbox] {\n  margin-right: 10px;\n}\nc-task .focus-group {\n  display: flex;\n  flex-direction: row;\n  align-items: center;\n  justify-content: center;\n  gap: 8px;\n  height: 24px;\n}\nc-task .focus-group .cancel {\n  cursor: pointer;\n  height: 100%;\n  font-size: 24px;\n  color: rgba(2, 22, 39, 0.6509803922);\n  display: flex;\n  align-items: center;\n  justify-content: center;\n}\nc-task .focus-group .submit {\n  cursor: pointer;\n  height: 100%;\n  background-color: #0099FF;\n  font-size: 11px;\n  font-weight: 700;\n  color: #fff;\n  border-radius: 5px;\n  padding: 4px;\n  display: flex;\n  gap: 4px;\n  align-items: center;\n  justify-content: center;\n}\nc-task .delete {\n  background-color: rgba(0, 31, 61, 0.0509803922);\n  border-radius: 5px;\n  width: 24px;\n  height: 24px;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  cursor: pointer;\n}c-task-group {\n  display: flex;\n  flex-direction: column;\n  box-shadow: 0 2px 8px -2px rgba(0, 37, 61, 0.2784313725);\n  padding: 12px;\n  gap: 1px;\n  border-radius: 12px;\n}@font-face {\n  font-family: "San Francisco";\n  font-weight: 400;\n  src: url("https://applesocial.s3.amazonaws.com/assets/styles/fonts/sanfrancisco/sanfranciscodisplay-regular-webfont.woff");\n}\n* {\n  box-sizing: border-box;\n}'));
...
class Task extends HTMLElement {
  ...
  bindEvents() {
    ...
    this.$input.on("focus", () => {
      ...
      $$1(document).on("mousedown.task-blur", (e) => {
        if (!this.contains(e.target)) {
          this.escape();
          $$1(document).off("mousedown.task-blur");
        }
      });
    });
